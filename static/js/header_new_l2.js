			...
			<div class="linkBox" @mouseenter="setWhiteBox()">
				<ul class="navUl">
					<li @mouseenter="changeActIndex(0)"><a @mouseenter="changeActIndex(0)" href="../../index.html"
							:class="whiteMode?(ifTrans?'whiteColor':'blackColor'):'txt'">首页</a></li>
					<li @mouseenter="changeActIndex(1)"><a @mouseenter="changeActIndex(1)" href="../dnzl/index.html"
							class="actLink">产品中心</a></li>
					<li @mouseenter="changeActIndex(2)"><a @mouseenter="changeActIndex(2)" href="../../enteryy.html"
							:class="whiteMode?(ifTrans?'whiteColor':'blackColor'):'txt'">走进一元</a></li>
					<li @mouseenter="changeActIndex(0)"><a @mouseenter="changeActIndex(0)" href="../../join.html"
							:class="whiteMode?(ifTrans?'whiteColor':'blackColor'):'txt'">加入一元</a></li>
					<li @mouseenter="changeActIndex(0)"><a @mouseenter="changeActIndex(0)" href="../../contact.html"
							:class="whiteMode?(ifTrans?'whiteColor':'blackColor'):'txt'">联系我们</a></li>
				</ul>
			</div>
			<!-- 搜索框 -->
			<div class="searchBox">
